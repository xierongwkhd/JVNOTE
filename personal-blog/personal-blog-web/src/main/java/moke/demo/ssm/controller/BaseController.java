...
public class BaseController {
    ...
    public Page<UserContent> getUserContentList(Long uid,Integer pageNum, Integer pageSize){
        Page<UserContent> list = userContentService.findByUserId(uid,pageNum,pageSize);
        return list;
    }
