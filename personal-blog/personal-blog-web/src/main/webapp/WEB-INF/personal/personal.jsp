...
<div class="author-card follow-box">
    <div class="designer-card card-media">
        ...
        <div class="author-info">
            ...
            <div style="float: left;margin-top: 40px; margin-left: 130px;">
                <a href="${ctx}/profile?id=${user.id}" style="text-decoration: none"><i class="icon icon-edit"></i><span style="margin-left: 10px">修改个人资料</span></a>
            </div>
        </div>
    </div>
    ...
    <div class="dreamland-see" id="dreamland-see" style="margin-top: 510px">
        <div class="customer" style="height: 40px;background-color:#262626;line-height: 40px ">
            <font color="white" size="2.8" face="黑体" style="margin-top: 10px;margin-left: 10px">关注(5人)</font>
        </div>
        <br/>
    ...
    <!--被关注-->
    <div class="dreamland-bysee" id="dreamland-bysee" style="margin-top: 1150px">
        <div class="customer" style="height: 40px;background-color:#262626;line-height: 40px ">
            <font color="white" size="2.8" face="黑体" style="margin-top: 10px;margin-left: 10px">被关注(6人)</font>
        </div>
        <br/>
        <div class="author clearfix" style="margin-left: 10px">
            <div>
    ...
    <div class="dreamland-content" style="background-color: white">
        <div class="content-bar">
            ...
            <div id="personal-div" style="background-color: #F0F0F0;width: 120px;text-align: center;height: 40px;line-height: 40px;float: left;margin-left: 20px" onclick="personal_dreamland();">
                ...
                <span id="personal-span"  style="color: black">私密的博客</span>
        ...
        <div id="release-dreamland" style="height: 700px;margin-top: 50px;width: 100%">
            ...
            <div id="release-dreamland-div" style="float: left;position: absolute;bottom: 740px;margin-left: 20px">
        ...
        <div id="update-dreamland" style="height: 700px;margin-top: 50px;width: 100%;display: none" >
            ...
            <div style="float: left;position: absolute;bottom: 740px;margin-left: 20px" id="update-dreamland-div">
        ...
        <div id="personal-dreamland" style="height: 700px;margin-top: 50px;width: 100%;display: none">
            ...
            <div id="personal-dreamland-div" style="float: left;position: absolute;bottom: 740px;margin-left: 20px">
        ...
        <div class="hot-dreamland" style="height: 700px">
            <div style="text-align: center;margin-top: 20px">博客推荐
        ...
        <div class="foot-nav clearfix" style="position: absolute;left: 0px;margin-top: 20px;margin-left: 400px;text-align: center">
            <div class="foot-copyrights" style="margin-left: 100px">
                ...
                <p>
                    ...
                    <span style="color: white">邮箱：xxx@moke.blog</span>
                </p>
                <p style="margin-top: 8px;color: white;font-size: 12px">&copy;www.mokeblog.com MOKE版权所有</p>
            </div>
        </div>
    </div>
</div>
