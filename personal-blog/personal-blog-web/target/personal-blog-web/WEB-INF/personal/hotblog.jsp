    ...
    <nav class="navbar navbar-inverse">
        ...
        <div id="navbar-menu" class="collapse navbar-collapse">
            <ul class="nav navbar-nav">
                <li><a href="${ctx}/index.jsp">最新博客</a></li>
                <li class="active"><a href="#">最热博客</a></li>
                <li><a href="${ctx}/watchc">我的博客</a></li>
        ...
        <div class="col-md-9"  style="background-color: white;">
            ...
            <div id="page-info" style="position: absolute;width:900px;background-color: #EBEBEB;height: 80px;left: 0px;">
                <ul class="pager pager-loose">
                    ...
                    <c:if test="${page.pageNum > 1}">
                        <li class="previous"><a href="${ctx}/watchh?pageNum=${page.pageNum-1}&&keyword=${keyword}">« 上一页</a></li>
                    </c:if>
                    <c:forEach begin="${page.startPage}" end="${page.endPage}" var="pn">
                        ...
                        <c:if test="${page.pageNum!=pn}">
                            <li ><a href="${ctx}/watchh?pageNum=${pn}&&keyword=${keyword}">${pn}</a></li>
                        </c:if>
                    </c:forEach>
                    ...
                    <c:if test="${page.pageNum<page.pages}">
                        <li><a href="${ctx}/watchh?pageNum=${page.pageNum+1}&&keyword=${keyword}">下一页 »</a></li>
                    </c:if>
                ...
                <div class="foot-nav clearfix" style="position: absolute;left: 0px;margin-top: 40px;text-align: center">
                    <div class="foot-copyrights" style="margin-left: 200px">
                        ...
                        <p>
                            ...
                            <span>邮箱：xxx@moke.blog</span>
                        </p>
                        <p style="margin-top: 8px">&copy;www.mokeblog.com MOKE版权所有</p>
                    </div>
                </div>
            </div>
            <!--col-md-9结束 -->
